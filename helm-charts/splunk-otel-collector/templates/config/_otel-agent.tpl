...
# If the gateway deployment is enabled, it will use a otlp_grpc exporter to send from the daemonset
  ...
  transform/k8s_proxy_histogram:
    metric_statements:
      ...
      - merge_histogram_buckets(70.0) where metric.name == "kubeproxy_network_programming_duration_seconds"
      - merge_histogram_buckets(80.0) where metric.name == "kubeproxy_network_programming_duration_seconds"
      ...
      - merge_histogram_buckets(105.0) where metric.name == "kubeproxy_network_programming_duration_seconds"
