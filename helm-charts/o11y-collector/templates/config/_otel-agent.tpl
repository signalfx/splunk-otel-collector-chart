...
*/}}
{{- define "splunk-otel-connector.otelAgentConfig" -}}
extensions:
  health_check: {}
  k8s_observer:
...
processors:
  ...
  {{- include "splunk-otel-connector.otelMemoryLimiterConfig" .Values.otelAgent | nindent 2 }}
...
exporters:
  ...
  otlp:
    endpoint: {{ include "splunk-otel-connector.fullname" . }}:55680
    insecure: true
  {{- else }}
