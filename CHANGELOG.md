...
This Splunk OpenTelemetry Collector for Kubernetes release adopts the [Splunk OpenTelemetry Collector v0.81.1](https://github.com/signalfx/splunk-otel-collector/releases/tag/v0.81.1).

### Fixed

- Use "ContainerAdministrator" user for windows nodes by default [#809](https://github.com/signalfx/splunk-otel-collector-chart/pull/858)
