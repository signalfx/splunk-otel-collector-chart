...
func WriteUpdatedExpectedTracesResults(t *testing.T, file string, traces *ptrace.Traces) {
...
func WriteUpdatedExpectedMetricsResults(t *testing.T, file string, metrics *pmetric.Metrics) {
...
func WriteUpdatedExpectedLogsResults(t *testing.T, file string, logs *plog.Logs) {
