...
func WriteUpdatedExpectedTraceResults(t *testing.T, file string, traces *ptrace.Traces) {
...
func WriteUpdatedExpectedMetricResults(t *testing.T, file string, metrics *pmetric.Metrics) {
...
func WriteUpdatedExpectedLogResults(t *testing.T, file string, logs *plog.Logs) {
