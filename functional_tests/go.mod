...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/xk8stest v0.135.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.135.0 // indirect
