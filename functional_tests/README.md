...
- `UPDATE_EXPECTED_RESULTS`: Generate new golden files (expected test results) for functional test results.
  - The https://github.com/signalfx/splunk-otel-collector-chart/actions/workflows/functional_test_v2.yaml workflow can be used with the dispatch trigger and input UPLOAD_UPDATED_EXPECTED_RESULTS=true
